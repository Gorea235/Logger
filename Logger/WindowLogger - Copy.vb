...
Public Class WindowLoggerForm
    ...
    Public Sub New()
        ...
        Me.CreateHandle()
        AddHandler FormSize.WidthChanged, AddressOf Width_Changed
        AddHandler FormSize.HeightChanged, AddressOf Height_Changed
        AddHandler FormPos.XChanged, AddressOf X_Changed
        AddHandler FormPos.YChanged, AddressOf Y_Changed
        Me_Show()
    ...
    Private Sub WindowLogger_Closing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles Me.FormClosing
        e.Cancel = True
        Me_Hide()
    End Sub
    ...
    Private Sub proc_DataReceived(ByVal sender As Object, ByVal e As DataReceivedEventArgs)
        If e.Data IsNot Nothing Then Me.Invoke(UpdateRichTextBoxDelg, e.Data + Environment.NewLine)
    End Sub
    ...
    Private Sub ckbx_CheckedChangedHandle(ByVal sender As Object, ByVal e As EventArgs)
        Me.Invoke(ckbx_CheckedChangedDelg, sender.Checked)
    End Sub
